        ...
        <div class="htlfndr-steps">
            <ul class="htlfndr-progress">
                ...
                <li class="htlfndr-active-step">
                    <span class="htlfndr-step-number">2</span> <span class="htlfndr-step-description">{{$hostelInformation->first()->hostel_name}}</span>
                </li>
            </ul>
        </div>
                        ...
                        <div class="htlfndr-hotel-marks">
                            <div class="htlfndr-overview-rating">
                                <div class="htlfndr-rating-stars">
                                    <i class="fa fa-star htlfndr-star-color" style="color:chartreuse"></i>
                                        ...
                                        <div class="htlfndr-review-right-side">
                                            <article class="htlfndr-visitor-post">
                                                <header>
                                                    ...
                                                    @endif
                                                    <p>{{$rv->review}}</p>
                                                    <h6>Review time {{$rv->created_at}}</h6>
                                                </header>
                                            </article>
                                        </div>
                                    </div>
                                    ...
                                    <div class="htlfndr-review-right-side">
                                        <article class="htlfndr-visitor-post">
                                            <header>
                                                ...
                                                <h6>Review time {{$reviews->first()->created_at}}</h6>
                                            </header>
                                        </article>
                                    </div>
                                </div>
            ...
            <aside id="htlfndr-right-sidebar" class="col-sm-12 col-md-4 col-lg-3 htlfndr-sidebar htlfndr-sidebar-in-right" role="complementary" style="margin-top: 30px">
                ...
                <div class="widget htlfndr-hotel-visit-card mt-3" >
                    <div class="htlfndr-widget-main-content htlfndr-widget-padding">
                        ...
                        <div class="htlfndr-hotel-price"><span class="htlfndr-from">Hostel Rent</span> <span class="htlfndr-cost">{{$hostelInformation->first()->hostel_rent }}</span> </div> <!-- .htlfndr-hotel-price -->
                    </div>
                </div>

                <div class="widget htlfndr-near-properties">
                    <div class="htlfndr-widget-main-content">
                        <h3 class="widget-title">Hostels Nearby</h3>
                                                        ...
                                                        if(is_dir($directory))
                                                        {
                                                            ...
                                                            while (false !== ($fileName = readdir($dh))) 
                                                            {
                                                                ...
                                                                else 
                                                                {
                                                                    ...
                                                                    $data = '<img src="'.url($path).'" alt="hotel img" style="height: 50px"/>';
                                                                    break;    
                                                                }
                                                            }
                                                            closedir($dh);
