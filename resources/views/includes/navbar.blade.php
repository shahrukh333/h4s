<nav class="navbar navbar-expand-md navbar-dark bg-header navbar-laravel">
    <div class="container">
        @guest
            <a class="navbar-brand" href="{{ url('index') }}">
                <img src="{{ url('../resources/indexpageresources/images/gallery/logo.png') }}" alt="logo" style=" height: 50px;">               
            </a>
        @else
